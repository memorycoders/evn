...
import { Table, Button, Form, Input, Col, Row, Modal, Pagination } from "antd";
import {
...
function TemplateNotification(props) {
    ...
    const fetchData = async (pageIndex) => {
        ...
        try {
            const rs = await http.get(`web/admin/templates?template_type_id=${TEMPLATES_TYPE_ID.NOTIFICATION}&pageIndex=${pageIndex}&pageSize=5`);
            if (rs?.status === 200) {
    ...
    const onFinish = async (values) => {
        try {
            ...
            var request = {
                ...
                "templateTypeId": TEMPLATES_TYPE_ID.NOTIFICATION
        ...
        <div className="digital-signature operate-signature">
            <div style={{ marginTop: '20px', maxWidth: size > 1440 ? '100%' : '1440px' }} className="digital-signature operate-signature">
                <div className="loanlist-operate">
                    <h2 style={{ marginLeft: '5px' }}>Thông báo</h2>
                    <Table
